...
//char subject[30] - ประกาศขอบเขตของตัวอักษรสำหรับเก็บชื่อวิชา
...
//18 printf แสดงตัวอักษรแรกของวิชา (`subject[0]`), ตัวอักษรแรกของชื่อ (`name[0]`), เกรด (`grade`) ที่แสดงทศนิยม 2 ตำแหน่ง (`%.2f`), และสัญลักษณ์เกรด (`symbol`)
//20 จบการทำงาน